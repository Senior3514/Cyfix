...
import { CategoryGauges } from "@/components/dashboard/category-gauges";
...
/**
 * The result, read three ways: the headline score, which family of checks is
 * weakest, and the whole surface at once. One number alone invites the next
 * question and answers none of it.
 */
    ...
    <Card>
      <CardBody className="space-y-5">
        ...
        <div className="border-t border-graphite-700 pt-5">
          <CategoryGauges findings={result.findings} />
        </div>

        <div className="border-t border-graphite-700 pt-5">
          <CoverageMap findings={result.findings} selectedId={selectedId} onSelect={onSelect} />
        </div>
      </CardBody>
    </Card>
  );
